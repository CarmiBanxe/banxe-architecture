...
|---|-----------------------|-----------------------------------------|------------------|
| **LLM01** | Prompt Injection | Prompt-canon (`PROMPT-CANON-DEVELOPER.md` / `PROMPT-CANON-PROJECT.md`); runtime enforcement **pending #65 NeMo-Guardrails / #104 Guardrails.ai** | ☐ PASS ☐ GAP ☐ N-A |
...
| **LLM05** | Improper Output Handling | Output validators **pending #104 Guardrails.ai**; structured-output contracts; no-authority canon (recall/output confers no permission, ADR-130/127) | ☐ PASS ☐ GAP ☐ N-A |
...
- Pending runtime complements: **#65 nemo-guardrails-runtime-safety**, **#104 guardrails-ai-validators**.
