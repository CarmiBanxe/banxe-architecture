...
**Source: Synthetic corpus — generated by Sub-terminal A via qwen3:30b-a3b on evo2, 4000 labeled examples (1000 per class), sandbox-only per operator decision 2026-05-12 (Sub-A best-decision pick, Reviewer=Perplexity sandbox scope, NOT for production)**
