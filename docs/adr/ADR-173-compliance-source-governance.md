# ADR-173: Compliance source governance — иерархия источников, risk weighting, evidence usage

**Status:** Proposed (DRAFT / NOT FOR MERGE — ратификация MLRO + оператор)
**Date:** 2026-07-18
**Numbering note:** номер выделен локально (следующий после ADR-172); Central подтверждает при merge.
