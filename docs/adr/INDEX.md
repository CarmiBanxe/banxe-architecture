...
(factory ADRs post-D3.2d.1 renumber, 7 files incl. ADR-045 Intent-First, 2026-06-07)
...
ADR-038, ADR-074..077 (38 files); `docs/adr/` holds ADR-039..045 (7 files;
factory / agent governance scope). Numbers ADR-021, ADR-023, ADR-031, ADR-037,
ADR-046..073, ADR-078+ are unassigned (see §"MISSING / unassigned").
...
## Real ADR files in `docs/adr/` (factory governance, 7 files)
...
| ADR-046..073     | UNASSIGNED block — 28 free numbers between docs/adr/ and Ghost-Mode set. |
