...
ADR-038, ADR-074..077 (38 files); `docs/adr/` holds ADR-039..054 (16 files;
factory / agent governance scope). Numbers ADR-021, ADR-023, ADR-031, ADR-037,
ADR-055..073, ADR-078+ are unassigned (see §"MISSING / unassigned").
...
## Real ADR files in `docs/adr/` (factory governance, 16 files)
...
| ADR-055..073     | UNASSIGNED block — 19 free numbers between docs/adr/ and Ghost-Mode set. |
