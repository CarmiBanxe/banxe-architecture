# Model Card — project-reason (alias)  (DRAFT — pending operator/CRO approval)
...
## 1. Identity
- **Model / alias:** `project-reason (alias)`
- **Role in canon:** LiteLLM alias — architecture / cross-repo reasoning route.
...
## 2. Provenance
- **Alias resolution:** **alias → `qwen3:235b-a22b (Q3_K_S)`** — project-reason → qwen3-235b-Q3_K_S, evo2 :8082 (factory-routing-map).
...
- **Intended use:** architecture / cross-repo reasoning, MLRO-escalation, fraud explanation — human-reviewed.
