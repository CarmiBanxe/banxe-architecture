...
HITLProposal: action + reason-строка с именем entity и типом матча (possible/confirmed) + requires_approval_from; списочная атрибуция (какой лист дал hit) — Tier-A источники (ADR-174).
