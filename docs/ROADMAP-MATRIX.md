...
| P2 (Operational) | 9 | L-lake (30%), B-pricing (Spec-Locked, In Progress — IL-512, commercial pricing catalogue: tiers/rules/published fee schedules, config-as-data; rate source for D-fee engine, no fee-engine/billing reimpl) | All others 0% |
