...
| ADR-173 | source governance: иерархия источников Tier-A/B/C; блокировки — только Tier-A | `docs/adr/ADR-173-compliance-source-governance.md` | reference only (DRAFT/PROPOSED) |
...
- [operator] UBO-скрин: подтверждение Tier-A-only для блокировок (ADR-173).
...
5. Референсы: ADR-102, ADR-173, `INVARIANTS.md` (I-27)
