...
**Опоры:** ADR-047 + `governance/ai-cost-policy/` (README v1, agent-budget-policy.md §2/§5), `services/runtime_gate/` (BudgetManager, BudgetHaltGate, kill_switch — S-A2), ADR-046 (lineage), ADR-156 (sandbox-mode), ADR-173 draft (Autonomy Ladder).
