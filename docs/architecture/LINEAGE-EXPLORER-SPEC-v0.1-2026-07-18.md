...
3. **SMF evidence pack** — Q2+Q4+Q6 за календарный месяц, экспорт в один файл (markdown/CSV) для monthly review (вход L4-гейта ADR-173; поставщик evidence для Audit Pack Builder OSINT-P1-6).
