# BANK FOUR-FLOOR MEMO — DRAFT HANDOFF FOR CENTRAL TERMINAL

> **Title:** BANK Four-Floor Memo — durable capture for Central terminal (bank build track)
> **Date:** 2026-07-18
> **Source:** Fable 5 read-only synthesis from banxe-architecture (origin/main @ c66c198); 4 explore-агента + точечная grep-верификация
> **Status:** **DRAFT / NOT FOR MERGE** — операторский HITL обязателен перед любым merge
> **Role note:** фабрика строит ФАБРИКУ; БАНК строит Central terminal. Этот файл — durable input для Central (bank roadmap/sprints to 100% launch readiness), не фабричный roadmap.
> **Ephemeral pointers (не источники канона, локации временные):**
> - transcript: `/home/mmber/.claude/projects/-home-mmber-banxe-emi-stack/350981a0-8c2e-49c4-ae0b-ede5b1bbaa4e.jsonl`
> - HTML audit artifact: `/tmp/claude-1000/-home-mmber-banxe-emi-stack/c16c2904-d87e-43e8-afb1-76cc5fac7961/scratchpad/artifact/agent-fleet-audit.html` (не инлайнится)
> **Version note:** финальная полная версия = MEMO v2 (9 секций; v1 из 8 секций superseded). Идентичное содержимое закоммичено как `docs/architecture/BANK-OPERATING-MODEL-FOUR-FLOORS-2026-07-18.md` @ dbc3574 в этой же ветке.
