...
- **What is canonised:**
  - HW baseline table added to `docs/canon/factory-project-stack-2026-05.md` (§"HW Baseline" — see commit in this PR).
  ...
  - Four gaps opened in GAP-REGISTER.md:
    * `G-FACTORY-WSL2-RAM-CAP` (P2) — Legion WSL2 cap prevents use of physical 64 GB; raise to ~56 GB.
...
- **Anchors:** `docs/canon/factory-project-stack-2026-05.md` (§"HW Baseline"), IL-CANON-STACK-2026-05-06, IL-CANON-RUFLO-2026-05-06, G-FACTORY-WSL2-RAM-CAP, G-INFRA-EVO1-RAM-VISIBILITY, G-INFRA-EVO2-GPU-STACK, G-CANON-HW-BASELINE, docs/canon/operator-canon-2026-05.md.
- **Reperential point:** main HEAD at 44afc60.
