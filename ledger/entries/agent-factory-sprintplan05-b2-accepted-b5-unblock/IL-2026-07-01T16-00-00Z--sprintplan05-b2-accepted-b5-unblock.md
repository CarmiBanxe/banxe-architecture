...
- **Change:** `docs/agent-engine-dossier/SPRINT-PLAN.md` §0 dashboard — two rows updated:
  ...
  - B5: `BLOCKED (gate-in: B2)` → `OPEN (gate-in: B2 ✅ cleared — ready to start)`
- **Gate-out:** B2 row reflects infra#27 + IL-770 + coverage/semgrep metrics; B5 gate-in satisfied; append-only (I-24).
