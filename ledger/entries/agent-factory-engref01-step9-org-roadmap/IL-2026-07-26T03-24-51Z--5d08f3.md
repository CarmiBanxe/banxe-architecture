...
- **Deviation:** STEP9-v2 expansion applied on same branch/PR (operator re-issued expanded order; v1 already at merge-boundary): +§0 parameters (canon-sourced), +§3 FCA-2026 layer (5 canon-hooks), +5 sprints (S-INTENT/S-COST/S-BDSL/S13-00/S-LINEAGE), director identity bound to ceo_orchestration_agent (GAP-078); operator order TRUNCATED at S-LINEAGE — tail not received, S6/S7/Z retained from v1 (OPEN POINT in doc §5).
