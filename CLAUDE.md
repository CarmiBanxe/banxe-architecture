...
**DEFENDER-VOICE PHRASING (директива оператора 2026-08-06):** во всех текстах
(промпты, ADR, коммиты, PR) — формулировки от защиты, не от атаки: «предотвращение
обхода санкционного контроля», не «обход санкций». Смысл не ослабляется; это гигиена
против ложных срабатываний model-side safeguards. Правило:
`.claude/rules/safeguard-safe-phrasing.md`. Fallback модели на flagged-ходе не
отменяет консультацию (ADR-181).
